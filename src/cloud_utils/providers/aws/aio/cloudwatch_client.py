"""
CloudWatch Metrics 비동기식 클라이언트 모듈

이 모듈은 AWS CloudWatch Metrics를 조회하기 위한 비동기식 클라이언트를 제공합니다.
aioboto3를 사용하여 비동기로 작동하며, 여러 dimension을 지원합니다.
"""
...
class AsyncCloudWatchMetricsClient:
    ...
    def __init__(
        ...
        **kwargs
        ...
        """
        CloudWatch Metrics 비동기 클라이언트 초기화
        ...
        Args:
            ...
            **kwargs: aioboto3 클라이언트에 전달할 추가 인자
        """
    ...
    async def _get_client(self):
        """aioboto3 세션에서 CloudWatch 클라이언트 생성"""
        try:
