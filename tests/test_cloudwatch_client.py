"""
CloudWatch Metrics Client Tests

This file tests the basic functionality of CloudWatch Metrics client.
"""
...
class TestMetricDimension:
    """MetricDimension class tests"""
    
    def test_metric_dimension_creation(self):
        """Test MetricDimension creation"""
    ...
    def test_metric_dimension_to_dict(self):
        """Test MetricDimension to_dict method"""
...
class TestMetricQuery:
    """MetricQuery class tests"""
    
    def test_metric_query_creation(self):
        """Test MetricQuery creation"""
    ...
    def test_metric_query_to_metric_stat_query(self):
        """Test MetricQuery to_metric_stat_query method"""
        dimensions = [MetricDimension("Service", "processor")]
        query = MetricQuery(
            namespace="MyApp/Metrics",
            metric_name="ResourcesProcessed",
    ...
    def test_metric_query_with_expression(self):
        """Test MetricQuery with expression"""
        query = MetricQuery(
            namespace="MyApp/Metrics",
            metric_name="ResourcesProcessed",
            dimensions=[],
...
class TestCloudWatchMetricsClient:
    """CloudWatchMetricsClient class tests"""
    ...
    def test_process_metric_data_response(self):
        """Test _process_metric_data_response method"""
